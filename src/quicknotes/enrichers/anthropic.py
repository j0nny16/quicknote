...
- summary: 1-2 sentences capturing the gist. Only what the note actually says -- \
  never invent detail, never add advice.
...
class _Schema(BaseModel):
    ...
    summary: str = Field(description="1-2 sentences with the gist of the note")
